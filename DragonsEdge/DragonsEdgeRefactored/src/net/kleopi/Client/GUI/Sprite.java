...
public enum Sprite
{
	...
	WATER_CHARACTER_LEFT("picturepath"), EARTH_CHARACTER_LEFT("gg"), FIRE_CHARACTER_LEFT("gg"), AIR_CHARACTER_LEFT(
			"gg"), WATER_CHARACTER_RIGHT("gg"), EARTH_CHARACTER_RIGHT("gg"), FIRE_CHARACTER_RIGHT(
					"gg"), AIR_CHARACTER_RIGHT(
							"gg"), WATER_CHARACTER_UP("gg"), EARTH_CHARACTER_UP("gg"), FIRE_CHARACTER_UP(
									"gg"), AIR_CHARACTER_UP("gg"), WATER_CHARACTER_DOWN(
											"gg"), EARTH_CHARACTER_DOWN(
													"gg"), FIRE_CHARACTER_DOWN(
															"gg"), AIR_CHARACTER_DOWN("gg"), NO_SPRITE("gg");
